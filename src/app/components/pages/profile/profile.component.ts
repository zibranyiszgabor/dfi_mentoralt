...
import { SpkFriendsCardComponent } from '../../../@spk/reusable-pages/spk-friends-card/spk-friends-card.component';
...
@Component({
  ...
  standalone: true,
  imports: [SharedModule,NgbNavModule,NgSelectModule,NgbDropdownModule,SpkProfileComponent,SpkGalleryComponent,
    GalleryModule,LightboxModule,FormsModule,ReactiveFormsModule ,SpkFriendsCardComponent],
