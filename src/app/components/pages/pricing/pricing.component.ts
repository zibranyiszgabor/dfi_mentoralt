...
@Component({
  ...
  standalone: true,
  imports: [NgbNavModule,FormsModule,ReactiveFormsModule,CommonModule,SharedModule,SpkPricingComponent,SpkPricing1Component,SpkPricing2Component],
...
export class PricingComponent {
  ...
  monthlyplans = [
    {
      ...
      billingCycle1: ' Monthly',
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam.',
      features: [
        { text: '2 Free Websites', isAvailable: true },
        { text: '1 GB Hard disk storage', isAvailable: true },
        { text: '1 Year Email support', isAvailable: false },
        { text: '2 Licenses', isAvailable: false },
        { text: 'Custom SEO optimization', isAvailable: false },
        { text: 'Chat Support', isAvailable: false },
      ],
    ...
    },
    {
      ...
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam.',
      features: [
        { text: '5 Free Websites', isAvailable: true },
        { text: '5 GB Hard disk storage', isAvailable: true },
        { text: '2 Years Email support', isAvailable: true },
        { text: '5 Licenses', isAvailable: true },
        { text: 'Custom SEO optimization', isAvailable: false },
        { text: 'Chat Support', isAvailable: false },
      ],
      buttonClass: 'btn-light',
    ...
    },
    {
      ...
      planName: 'Business',
      badgeText: 'For Business Purpose',
      ...
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam.',
      features: [
        { text: '10 Free Websites', isAvailable: true },
        { text: '20 GB Hard disk storage', isAvailable: true },
        { text: '3 Years Email support', isAvailable: true },
        { text: '15 Licenses', isAvailable: true },
        { text: 'Custom SEO optimization', isAvailable: true },
        { text: 'Chat Support', isAvailable: false },
      ],
  ...
  pricingPlans = [
    ...
    {
      planName: 'Enterprise',
      badgeText: 'For Large Companies',
      badgeClass: 'bg-success-transparent',
      price: '$7,999',
      billingCycle: 'Per Month',
      description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam.',
      features: [
        { text: '20 Free Websites', isAvailable: true },
        { text: '30 GB Hard disk storage', isAvailable: true },
        { text: '5 Years Email support', isAvailable: true },
        { text: '50 Licenses', isAvailable: true },
        { text: 'Custom SEO optimization', isAvailable: true },
        { text: 'Chat Support', isAvailable: true },
      ],
      buttonClass: 'btn-primary',
      buttonText: 'Choose Plan',
      highlightClass: '',
