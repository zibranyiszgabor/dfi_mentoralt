...
export class InputsComponent {
  ...
  ts1: string = codeData.inputTS1;
  ts2: string = codeData.inputTS2;
  ts3: string = codeData.inputTS3;
  ts4: string = codeData.inputTS4;
  ts5: string = codeData.inputTS5;
  ts6: string = codeData.inputTS6;
  ts7: string = codeData.inputTS7;
  ts8: string = codeData.inputTS8;
